...
class PaginationView extends View {
  ...
  _generateMarkup() {
    ...
    if (this.currentPage === 1 && this._numPages > 1)
      return this._gereneteMarkupBtnNextPage();
    ...
    // Last page
    if (this._numPages === this.currentPage && this.currentPage > 1)
      return this._gereneteMarkupBtnPreviousPage();
